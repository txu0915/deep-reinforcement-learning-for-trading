...
insample_turbulence = data[(data.datadate<20210101) & (data.datadate>=20090000)]
insample_turbulence = insample_turbulence.drop_duplicates(subset=['datadate'])
insample_turbulence_threshold = np.quantile(insample_turbulence.turbulence.values, .90)

start = time.time()
trade_start_date = 20151001#20211001
validation_end_date = 20150930#20210930
validation_start_date = 20150701#20210701
training_end_date = 20150630#20210630
today = 20220106
...
model_a2c = train_A2C(env_train, model_name="A2C_30k_dow_{}".format(i), timesteps=100)
